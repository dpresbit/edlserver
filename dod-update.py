...
datapath = Path(tempfile.gettempdir() + '/dod_endpoints_clientid_latestversion.txt')
...
version = webApiGet('version', 'USGovDoD', clientRequestId)
...
if version['latest'] > latestVersion:
    ...
    endpointSets = webApiGet('endpoints', 'USGovDoD', clientRequestId)
...
#    print('\n'.join(sorted(set([ip for (category, ip, tcpPorts, udpPorts) in flatIps]))))
    ...
    with open('/home/fedadmin/edlserver/dodedl.txt', 'w') as f:
        f.write(MyURLList)
